...
### Fixed
- Fixed "Skip" (Stay Hidden) mechanic: playing a trump-suit card when choosing Skip no longer incorrectly treats it as a trump. Cards are now properly treated as ordinary discards when trump is hidden, per game rules.

## [1.2.6] - 2026-04-25

### Changed
- Removed docs/rules.md file.
- Enhanced hard difficulty bot strategy with improved decision-making logic.
